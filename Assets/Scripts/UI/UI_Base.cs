...
public class UI_Base : MonoBehaviour
{
    ...
    public static void AddUIEvent(GameObject go, Action<PointerEventData> action , Define.UIEvent type = Define.UIEvent.Click){ //Define 초기값으로는 가장 많이 쓰는 click 이벤트루 지정
